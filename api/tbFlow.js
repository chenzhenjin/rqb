...
export const saveTaskFlow = (params = {}) => {
    return ajaxPost(config.serverUrl + 'yushu-popbao/flowTaobao/saveTaskFlow', params)
};
/**
 * 获取任务列表
 * @params String page
...
export const getFlowTaskList = (params = {}) => {
    return ajaxGet(config.serverUrl + 'yushu-popbao/flowTaobao/getFlowTaskList', params)
};
...
export const getTaskDateList = (params) => {
    return ajaxGet(config.serverUrl + 'yushu-popbao/flowTaobao/getTaskDateList', params)
};
...
export const getGoodsInfo = (params) => {
    return ajaxGet(config.serverUrl + 'yushu-popbao/flowTaobao/getGoodsInfo', params)
};
...
export const getCostList = (params) => {
    return ajaxGet(config.serverUrl + 'yushu-popbao/flowTaobao/getCostList', params)
};
...
export const releaseTaskFlow = (params) => {
    return ajaxPost(config.serverUrl + 'yushu-popbao/flowTaobao/releaseTaskFlow', params)
};
 ...
 */
export const getTaobaoShop = (params) => {
    return ajaxGet(config.serverUrl + 'yushu-jdapi/api/getTaobaoShop', params)
};